...
public class SpawnSpeedUp : MonoBehaviour
{
    ...
    void SpawnPrefab()
    {
        ...
        GameObject leftBox = Instantiate(SpeedBox, randomPositionLeft, Quaternion.identity); //speed box spawning on the left
        GameObject rightBox = Instantiate(SpeedBox, randomPositionRight, Quaternion.identity); //speed box spawning on the right
